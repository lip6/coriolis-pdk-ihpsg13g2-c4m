...
%endif
URL:            https://github.com/lip6/c4m-ihpsg13g2-pdk
Source0:        c4m-ihpsg13g2-pdk-%{dateVersion}.tar.gz
...
%if 0%{?is_opensuse}
%global _pyproject_wheeldir %{_builddir}/c4m-ihpsg13g2-pdk-%{version}/build
...
%package -n python%{python3_pkgversion}-c4m-ihpsg13g2-pdk
Summary:        %{summary}


%description -n python%{python3_pkgversion}-c4m-ihpsg13g2-pdk
%_description


%prep
%autosetup -p1 -n c4m-ihpsg13g2-pdk-%{version} -a 1
...
%files -n python%{python3_pkgversion}-c4m-ihpsg13g2-pdk
%doc README.rst
%license LICENSE
%dir %{python3_sitearch}/pdks
%{python3_sitearch}/pdks/c4m_ihpsg13g2
%{python3_sitearch}/c4m_ihpsg13g2_pdk-%{dateVersion}.dist-info
